export type CorpusWord = { english: string; phonemes: string[] };

export const CORPUS_3: CorpusWord[] = [
...
export const CORPUS_4: CorpusWord[] = [
...
export const CORPUS_5: CorpusWord[] = [
...
export const CORPUS_ALL: CorpusWord[] = [...CORPUS_3, ...CORPUS_4, ...CORPUS_5];

export function pickRandomCorpusWords(count: number, pool: CorpusWord[] = CORPUS_ALL): CorpusWord[] {
